  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-white p-6 space-y-6">
        <h3 className="font-sans text-xs font-bold uppercase tracking-widest text-muted">
          Avaliação
        </h3>
        <StarRating
          name="overallRating"
          label="Avaliação geral da apresentação"
        ...
        <StarRating
          name="contentRating"
          label="Qualidade do conteúdo científico"
          value={ratings.content}
          onChange={setRating("content")}
        />
        <div className="h-px bg-border" />
        <StarRating
          name="didacticsRating"
          label="Didática e clareza na apresentação"
          value={ratings.didactics}
          onChange={setRating("didactics")}
        />
        <div className="h-px bg-border" />
        <StarRating
          name="applicability"
          label="Aplicabilidade clínica do conteúdo"
          value={ratings.applicability}
          onChange={setRating("applicability")}
        />
      </div>
      ...
      <div className="rounded-2xl border border-border bg-white p-6 space-y-5">
        ...
        <div>
          <label className="font-sans text-sm font-medium text-foreground block mb-2">
            O que mais gostou na apresentação?
          </label>
          <textarea
            name="highlight"
            rows={3}
            placeholder="Compartilhe o que mais te impactou..."
        ...
        <div>
          <label className="font-sans text-sm font-medium text-foreground block mb-2">
            Sugestão de tema para próximas apresentações
          </label>
          <textarea
            name="nextTopicSuggest"
            rows={2}
            placeholder="Que assunto você gostaria de ver na próxima palestra?"
            className="w-full px-4 py-3 text-sm text-foreground bg-background border border-border rounded-xl placeholder:text-muted/40 focus:outline-none focus:border-primary/50 resize-none transition-colors"
          />
        </div>
      </div>
