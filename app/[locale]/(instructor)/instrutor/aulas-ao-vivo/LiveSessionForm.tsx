    ...
    <form ref={formRef} action={handleSubmit} className="flex flex-col gap-4">
      ...
      <div>
        ...
        <input
          name="title"
          required
          placeholder="Ex: Aula ao vivo — Módulo 1"
          className="w-full text-sm border border-border rounded-lg px-3 py-2 bg-background text-foreground"
        />
      </div>
      ...
      <button
        type="submit"
        className="w-full font-sans text-sm font-semibold px-4 py-2.5 rounded-xl bg-primary text-white hover:bg-primary-dark transition-colors mt-1"
      >
        Criar sessão
      </button>
    </form>
