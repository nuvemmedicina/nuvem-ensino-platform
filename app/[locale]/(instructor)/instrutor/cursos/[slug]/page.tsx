...
export default async function InstructorCursoEditPage({ params }: Props) {
  ...
  const updateCourseAction = updateCourseContent.bind(null, course.id, slug);
        ...
        <form action={updateCourseAction} className="space-y-4">
          ...
          <div className="border border-border rounded-xl overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-2.5 bg-background border-b border-border">
              <span className="font-sans text-xs font-bold text-muted uppercase tracking-widest">
                🇺🇸 English
              </span>
            </div>
            <div className="p-4 space-y-3">
              ...
              <div>
                ...
                <input
                  name="shortDescEn"
                  defaultValue={course.shortDescEn ?? ""}
                  placeholder={course.shortDesc ?? ""}
                  className={inputClass}
                />
              </div>
              <div>
          ...
          <div className="border border-border rounded-xl overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              ...
              <div>
                ...
                <input
                  name="shortDescEs"
                  defaultValue={course.shortDescEs ?? ""}
                  placeholder={course.shortDesc ?? ""}
                  className={inputClass}
                />
              </div>
              <div>
                ...
                <textarea
                  name="descriptionEs"
                  defaultValue={course.descriptionEs ?? ""}
                  placeholder={course.description}
                  rows={4}
                  className={`${inputClass} resize-none`}
                />
